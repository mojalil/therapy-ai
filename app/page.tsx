...
export default function IndexPage() {
  return (
    <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
      ...
      <div>
        <h1 className="text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl">Choose your Therapist</h1>
      </div>
      <div className="flex items-center">
      <Therapist therapistImage="/therapist_1.png"/> <Therapist therapistImage="/therapist_2.png" />
      </div>
